...
class OccupancyInput extends StatefulWidget {
  const OccupancyInput({super.key});

  @override
  State<OccupancyInput> createState() => _OccupancyInputState();
}

class _OccupancyInputState extends State<OccupancyInput> {
